...
@section('content')
    ...
    <h3 class="pt-4 text-4xl font-medium text-center mb-4">Listagem de clientes</h3>
    <div
                        ...
                        <tbody>
                            @foreach ($clientes as $item)
                                <tr
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 font-medium">{{ $item->telefone ?? '' }}</td>
                                    <td class="whitespace-nowrap px-6 py-4"><a
                                            href="{{ route('cliente.detalhes', $item->id) }}" class="bg-green-500 hover:bg-green-600 text-white
                            font-semibold py-2 px-4 rounded focus:outline
